...
class Slack:
    ...
    def __connect__(self):
        ...
        if self.slack_client.rtm_connect(with_team_state=False):
            logging.info("Chatty connected and running!")

            # Send a connection success message
            self.slack_client.api_call(
                "chat.postMessage",     # slack web API
                channel=self.channel,
                text="Chatty connected and running!"
            )
            ...
            while True:
                ...
                for slack_message in self.slack_client.rtm_read():
                    ...
                    logging.info("New message send: '{}' from: {}".
                                  format(message, user))
